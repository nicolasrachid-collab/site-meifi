...
const MenuOverlay: React.FC<MenuOverlayProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col md:flex-row bg-white text-black animate-fade-in">
      ...
      <div className="w-full md:w-1/2 h-2/3 md:h-full flex flex-col p-8 md:p-12 lg:p-16 relative">
        ...
        <div className="flex-grow flex flex-col justify-center max-w-lg">
          <h1 className="text-4xl md:text-5xl font-normal tracking-tight mb-4 text-black uppercase">
            Entre em Contato
          </h1>
          <a href="mailto:contato@meifi.com.br" className="text-xl md:text-2xl border-b border-black pb-1 inline-block self-start hover:opacity-70 transition-opacity mb-16">
        ...
        <div className="flex items-end justify-between mt-auto pt-8 border-t border-transparent">
          ...
          <Grip className="w-5 h-5 text-black cursor-pointer hover:rotate-90 transition-transform" />
        </div>
