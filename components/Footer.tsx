    ...
    <footer className="w-full bg-[#08131A] text-white pt-24 pb-8 px-6 md:px-12 lg:px-16 overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start mb-20 gap-16">
        ...
        <div className="max-w-md">
          <h3 className="text-h2 md:text-h1 font-medium mb-6">
            Mantenha-se inspirado.
          </h3>
          <p className="text-gray-400 mb-8 text-body-lg">
          ...
          <div className="relative border-b border-white/20 pb-2 focus-within:border-white transition-colors duration-300">
            <input 
              ...
              className="w-full bg-transparent border-none outline-none text-white placeholder-gray-500 text-body-lg pr-12 pb-1"
            />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-24 w-full lg:w-auto">
          ...
          <div className="flex flex-col gap-4">
            <h4 className="text-body-sm font-bold uppercase tracking-[0.05em] text-gray-500 mb-2">Explorar</h4>
            {['Projetos', 'Expertise', 'Studio', 'Notícias', 'Contato'].map((item) => (
              <a key={item} href="#" className="text-body text-gray-300 hover:text-white transition-colors">
                {item}
              </a>
            ))}
          </div>
          ...
          {/* Column 2 */}
          <div className="flex flex-col gap-4">
            <h4 className="text-body-sm font-bold uppercase tracking-[0.05em] text-gray-500 mb-2">Social</h4>
          ...
          <div className="flex flex-col gap-4 col-span-2 md:col-span-1">
            <h4 className="text-body-sm font-bold uppercase tracking-[0.05em] text-gray-500 mb-2">Visite-nos</h4>
            <address className="text-body text-gray-300 not-italic">
              Escritório Central<br />
              Belo Horizonte, MG<br />
              Brasil
            </address>
            <a href="mailto:contato@meifi.com.br" className="text-body-lg text-white border-b border-white/30 self-start pb-0.5 hover:border-white transition-colors mt-2">
      ...
      {/* Bottom Section: Copyright & Legal */}
        <div className="flex flex-col md:flex-row justify-between items-center text-body-sm text-gray-500 gap-6 border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row gap-6 items-center">
            <span className="text-body-sm">&copy; 2025 MEIFI Arquitetura. Todos os direitos reservados.</span>
          ...
          <button 
            onClick={scrollToTop} 
            className="flex items-center gap-2 group text-body-sm text-white hover:text-gray-300 transition-colors font-medium"
          >
