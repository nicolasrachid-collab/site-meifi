...
const Navbar: React.FC<NavbarProps> = ({ onOpenMenu }) => {
  return (
    <nav className="w-full flex items-center justify-between">
      ...
      <button 
        onClick={onOpenMenu}
        className="p-2 hover:bg-white/10 rounded-full transition-all duration-300 ease-out focus:outline-none focus:ring-2 focus:ring-white/20 group relative hover:scale-110 active:scale-95"
        style={{
