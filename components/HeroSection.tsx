          ...
          <ScrollAnimationWrapper className="mt-8">
            <div className="relative group flex flex-col items-center">
              <button 
                ...
                className="px-8 py-3 bg-white text-black rounded-full font-medium text-lg transition-all duration-300 hover:animate-pulse-scale active:scale-95 shadow-lg relative z-10"
              >
                Solicite um Orçamento
              </button>
              
              {/* Tooltip Discreto */}
              <div className="absolute top-full mt-4 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out transform translate-y-2 group-hover:translate-y-0 text-xs font-light tracking-wide text-white/80 pointer-events-none bg-black/20 backdrop-blur-sm px-3 py-1 rounded-full border border-white/10">
          ...
          <div className="bg-glassDark/60 backdrop-blur-md p-2 pr-6 rounded-2xl flex items-center space-x-4 max-w-[90%] md:max-w-sm border border-white/10 shadow-2xl transition-all duration-500 ease-out hover:bg-glassDark/90 hover:border-white/30 hover:-translate-y-1 cursor-pointer group">
             ...
             <div className="flex flex-col flex-grow min-w-0">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center text-black shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:shadow-white/20 animate-pulse-scale">
