      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 items-start">
        ...
        <div className="w-full lg:w-[35%] flex flex-col">
           ...
           <div className="grid grid-cols-2 gap-y-10 gap-x-8 mb-12">
              <div>
                  <h4 className="font-bold text-sm mb-2 text-black">Date</h4>
                  <p className="text-gray-600 text-sm">Jun 13, 2025</p>
              </div>
              <div>
                  <h4 className="font-bold text-sm mb-2 text-black">Category</h4>
                  <p className="text-gray-600 text-sm">Home</p>
              </div>
              <div>
                  <h4 className="font-bold text-sm mb-2 text-black">Space Plan</h4>
                  <p className="text-gray-600 text-sm">3 Bedrooms, Open Kitchen</p>
              </div>
              <div>
                  <h4 className="font-bold text-sm mb-2 text-black">Timeline</h4>
