...
const DesignSection: React.FC = () => {
  return (
    <section className="w-full bg-[#FAFAFA] text-[#08131A] py-32 px-6 md:px-12 lg:px-[232px] overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8">
        ...
        <div className="md:col-span-12 lg:col-span-4 bg-white p-10 rounded-[10px] flex flex-col justify-between min-h-[400px] shadow-sm hover:shadow-xl transition-all duration-700 ease-out hover:-translate-y-1 border border-gray-100/50 group">
          <div>
        ...
        <div className="md:col-span-6 lg:col-span-3 flex flex-col gap-6 group">
          <div className="h-64 rounded-[10px] overflow-hidden relative shadow-sm border border-gray-100/50">
            <img 
        ...
        <div className="md:col-span-12 lg:col-span-2 flex flex-col gap-6 group">
           <div className="h-64 lg:h-full rounded-[10px] overflow-hidden relative min-h-[250px] shadow-sm border border-gray-100/50">
             <img 
...
const InfoCard: React.FC<InfoCardProps> = ({ number, title, description }) => {
  return (
    <div className="bg-white p-6 rounded-[10px] h-[290px] flex flex-col justify-between shadow-sm transition-all duration-700 ease-out hover:shadow-xl hover:-translate-y-1 hover:border-[#DFDBCE] border border-gray-100/50 cursor-default group/card min-h-[160px]">
