...
const ProjectRelatedSection: React.FC = () => {
  ...
  return (
    <section className="w-full bg-[#F9F9F9] text-black py-24 px-6 md:px-12 lg:px-16">
      ...
      <div className="flex justify-between items-center mb-10 border-t border-transparent">
        ...
        <div className="pt-1">
           <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="text-black">
